...
const techStacks = [
  ...
  { icon: "pythoni.png", language: "Python" },
  { icon: "java.gif", language: "Java" },
  { icon: "angular.png", language: "AngularJS" },
  { icon: "django.png", language: "Django" },
  { icon: "c.png", language: "C" },
  { icon: "mongodb.png", language: "MongoDB" },
  { icon: "post.png", language: "PostgreSQL" },
  { icon: "my.png", language: "MySQL" },
  { icon: "git.png", language: "GitHub" },
  { icon: "jira.png", language: "Jira" },
  { icon: "flask2.png", language: "Flask" },
];
