...
const socialLinks = [
  {
    ...
    subText: "@dhanshree-ahire",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/dhanshree-ahire-a1030a243?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@dhanshreeahire25",
    icon: Instagram,
    url: "https://www.instagram.com/dhanshreeahire25",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@dhanshree-ahire",
    icon: Github,
    url: "https://github.com/dhanshree-ahire",
    color: "#ffffff",
